...
const styles = StyleSheet.create({
  ...
  genericFileContainer: { padding: 32, alignItems: 'center' },
  genericFileName: { fontSize: 16, color: '#202124', marginTop: 16, marginBottom: 20, textAlign: 'center' },
  openFileButton: { backgroundColor: '#1967d2', paddingVertical: 10, paddingHorizontal: 20, borderRadius: 8 },
